...
from ledger import AccountLedger             # or wherever it lives
from tax_models import TaxTables             # if used in .get_tax_tables
...
#        self.ledger.set_scenario(self.scenario_id)
    ...
    def run_strategy(self):
        ...
        tax_tables = self.context.get_tax_tables(self.wb)
    ...
    def run_simulation(self, mode='fixed_rate', num_simulations=1000):
        ...
        self.results = simulate_montecarlo_withdrawals(
            config=self.config,
            df_my_portfolio=self.df_my_portfolio,
